...
abstract public class THash implements Cloneable, Externalizable {
	 ...
	 * @uml.property  name="_loadFactor"
	 */
    protected float _loadFactor;

    /**
	 * The maximum number of elements allowed without allocating more space.
	 * @uml.property  name="_maxSize"
	 */
	 ...
	 * @uml.property  name="_autoCompactRemovesRemaining"
	 */
	 ...
	 * @uml.property  name="_autoCompactionFactor"
	 */
    protected float _autoCompactionFactor;

    /**
	 * @see  #tempDisableAutoCompaction
	 * @uml.property  name="_autoCompactTemporaryDisable"
	 */

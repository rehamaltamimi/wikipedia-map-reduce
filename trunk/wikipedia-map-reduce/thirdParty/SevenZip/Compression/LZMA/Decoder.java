...
public class Decoder
{
	...
	class LenDecoder
	{
		...
		/**
		 * @uml.property  name="m_LowCoder"
		 * @uml.associationEnd  multiplicity="(0 -1)"
		 */
		BitTreeDecoder[] m_LowCoder = new BitTreeDecoder[Base.kNumPosStatesMax];
		/**
		 * @uml.property  name="m_MidCoder"
		 * @uml.associationEnd  multiplicity="(0 -1)"
		 */
		BitTreeDecoder[] m_MidCoder = new BitTreeDecoder[Base.kNumPosStatesMax];
		/**
		 * @uml.property  name="m_HighCoder"
		 * @uml.associationEnd  
		 */
	...
	/**
	 * @uml.property  name="m_OutWindow"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	OutWindow m_OutWindow = new OutWindow();
	/**
	 * @uml.property  name="m_RangeDecoder"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	SevenZip.Compression.RangeCoder.Decoder m_RangeDecoder = new SevenZip.Compression.RangeCoder.Decoder();
	
	/**
	 * @uml.property  name="m_IsMatchDecoders" multiplicity="(0 -1)" dimension="1"
	 */
	short[] m_IsMatchDecoders = new short[Base.kNumStates << Base.kNumPosStatesBitsMax];
	/**
	 * @uml.property  name="m_IsRepDecoders" multiplicity="(0 -1)" dimension="1"
	 */
	short[] m_IsRepDecoders = new short[Base.kNumStates];
	/**
	 * @uml.property  name="m_IsRepG0Decoders" multiplicity="(0 -1)" dimension="1"
	 */
	short[] m_IsRepG0Decoders = new short[Base.kNumStates];
	/**
	 * @uml.property  name="m_IsRepG1Decoders" multiplicity="(0 -1)" dimension="1"
	 */
	short[] m_IsRepG1Decoders = new short[Base.kNumStates];
	/**
	 * @uml.property  name="m_IsRepG2Decoders" multiplicity="(0 -1)" dimension="1"
	 */
	short[] m_IsRepG2Decoders = new short[Base.kNumStates];
	/**
	 * @uml.property  name="m_IsRep0LongDecoders" multiplicity="(0 -1)" dimension="1"
	 */
	short[] m_IsRep0LongDecoders = new short[Base.kNumStates << Base.kNumPosStatesBitsMax];
	
	/**
	 * @uml.property  name="m_PosSlotDecoder"
	 * @uml.associationEnd  multiplicity="(0 -1)"
	 */
	BitTreeDecoder[] m_PosSlotDecoder = new BitTreeDecoder[Base.kNumLenToPosStates];
	/**
	 * @uml.property  name="m_PosDecoders" multiplicity="(0 -1)" dimension="1"
	 */
	short[] m_PosDecoders = new short[Base.kNumFullDistances - Base.kEndPosModelIndex];
	
	/**
	 * @uml.property  name="m_PosAlignDecoder"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	BitTreeDecoder m_PosAlignDecoder = new BitTreeDecoder(Base.kNumAlignBits);
	
	/**
	 * @uml.property  name="m_LenDecoder"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	LenDecoder m_LenDecoder = new LenDecoder();
	/**
	 * @uml.property  name="m_RepLenDecoder"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="this$0:SevenZip.Compression.LZMA.Decoder$LenDecoder"
	 */
	LenDecoder m_RepLenDecoder = new LenDecoder();
	
	/**
	 * @uml.property  name="m_LiteralDecoder"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="this$0:SevenZip.Compression.LZMA.Decoder$LiteralDecoder"
	 */
	LiteralDecoder m_LiteralDecoder = new LiteralDecoder();
	
	/**
	 * @uml.property  name="m_DictionarySize"
	 */
	int m_DictionarySize = -1;
	/**
	 * @uml.property  name="m_DictionarySizeCheck"
	 */
	int m_DictionarySizeCheck =  -1;
	
	/**
	 * @uml.property  name="m_PosStateMask"
	 */
	int m_PosStateMask;

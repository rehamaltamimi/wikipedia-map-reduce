...
public class Encoder
{
	...
	/**
	 * @uml.property  name="_previousByte"
	 */
	byte _previousByte;
	/**
	 * @uml.property  name="_repDistances" multiplicity="(0 -1)" dimension="1"
	 */
	...
	/**
	 * @uml.property  name="_optimum"
	 * @uml.associationEnd  multiplicity="(0 -1)" inverse="this$0:SevenZip.Compression.LZMA.Encoder$Optimal"
	 */
	Optimal[] _optimum = new Optimal[kNumOpts];
	/**
	 * @uml.property  name="_matchFinder"
	 * @uml.associationEnd  
	 */
	SevenZip.Compression.LZ.BinTree _matchFinder = null;
	/**
	 * @uml.property  name="_rangeEncoder"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	SevenZip.Compression.RangeCoder.Encoder _rangeEncoder = new SevenZip.Compression.RangeCoder.Encoder();

	/**
	 * @uml.property  name="_isMatch" multiplicity="(0 -1)" dimension="1"
	 */
	short[] _isMatch = new short[Base.kNumStates<<Base.kNumPosStatesBitsMax];
	/**
	 * @uml.property  name="_isRep" multiplicity="(0 -1)" dimension="1"
	 */
	short[] _isRep = new short[Base.kNumStates];
	/**
	 * @uml.property  name="_isRepG0" multiplicity="(0 -1)" dimension="1"
	 */
	short[] _isRepG0 = new short[Base.kNumStates];
	/**
	 * @uml.property  name="_isRepG1" multiplicity="(0 -1)" dimension="1"
	 */
	short[] _isRepG1 = new short[Base.kNumStates];
	/**
	 * @uml.property  name="_isRepG2" multiplicity="(0 -1)" dimension="1"
	 */
	short[] _isRepG2 = new short[Base.kNumStates];
	/**
	 * @uml.property  name="_isRep0Long" multiplicity="(0 -1)" dimension="1"
	 */
	short[] _isRep0Long = new short[Base.kNumStates<<Base.kNumPosStatesBitsMax];

	/**
	 * @uml.property  name="_posSlotEncoder"
	 * @uml.associationEnd  multiplicity="(0 -1)"
	 */
	BitTreeEncoder[] _posSlotEncoder = new BitTreeEncoder[Base.kNumLenToPosStates]; // kNumPosSlotBits

	/**
	 * @uml.property  name="_posEncoders" multiplicity="(0 -1)" dimension="1"
	 */
	short[] _posEncoders = new short[Base.kNumFullDistances-Base.kEndPosModelIndex];
	/**
	 * @uml.property  name="_posAlignEncoder"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	BitTreeEncoder _posAlignEncoder = new BitTreeEncoder(Base.kNumAlignBits);

	/**
	 * @uml.property  name="_lenEncoder"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	LenPriceTableEncoder _lenEncoder = new LenPriceTableEncoder();
	/**
	 * @uml.property  name="_repMatchLenEncoder"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="this$0:SevenZip.Compression.LZMA.Encoder$LenPriceTableEncoder"
	 */
	LenPriceTableEncoder _repMatchLenEncoder = new LenPriceTableEncoder();

	/**
	 * @uml.property  name="_literalEncoder"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="this$0:SevenZip.Compression.LZMA.Encoder$LiteralEncoder"
	 */
	LiteralEncoder _literalEncoder = new LiteralEncoder();

	/**
	 * @uml.property  name="_matchDistances" multiplicity="(0 -1)" dimension="1"
	 */
	int[] _matchDistances = new int[Base.kMatchMaxLen*2+2];

	/**
	 * @uml.property  name="_numFastBytes"
	 */
	int _numFastBytes = kNumFastBytesDefault;
	/**
	 * @uml.property  name="_longestMatchLength"
	 */
	int _longestMatchLength;
	/**
	 * @uml.property  name="_numDistancePairs"
	 */
	int _numDistancePairs;

	/**
	 * @uml.property  name="_additionalOffset"
	 */
	int _additionalOffset;

	/**
	 * @uml.property  name="_optimumEndIndex"
	 */
	int _optimumEndIndex;
	/**
	 * @uml.property  name="_optimumCurrentIndex"
	 */
	int _optimumCurrentIndex;

	/**
	 * @uml.property  name="_longestMatchWasFound"
	 */
	boolean _longestMatchWasFound;

	/**
	 * @uml.property  name="_posSlotPrices" multiplicity="(0 -1)" dimension="1"
	 */
	int[] _posSlotPrices = new int[1<<(Base.kNumPosSlotBits+Base.kNumLenToPosStatesBits)];
	/**
	 * @uml.property  name="_distancesPrices" multiplicity="(0 -1)" dimension="1"
	 */
	int[] _distancesPrices = new int[Base.kNumFullDistances<<Base.kNumLenToPosStatesBits];
	/**
	 * @uml.property  name="_alignPrices" multiplicity="(0 -1)" dimension="1"
	 */
	int[] _alignPrices = new int[Base.kAlignTableSize];
	/**
	 * @uml.property  name="_alignPriceCount"
	 */
	int _alignPriceCount;

	/**
	 * @uml.property  name="_distTableSize"
	 */
	int _distTableSize = (kDefaultDictionaryLogSize * 2);

	/**
	 * @uml.property  name="_posStateBits"
	 */
	int _posStateBits = 2;
	/**
	 * @uml.property  name="_posStateMask"
	 */
	int _posStateMask = (4 - 1);
	/**
	 * @uml.property  name="_numLiteralPosStateBits"
	 */
	int _numLiteralPosStateBits = 0;
	/**
	 * @uml.property  name="_numLiteralContextBits"
	 */
	int _numLiteralContextBits = 3;

	/**
	 * @uml.property  name="_dictionarySize"
	 */
	int _dictionarySize = (1 << kDefaultDictionaryLogSize);
	/**
	 * @uml.property  name="_dictionarySizePrev"
	 */
	int _dictionarySizePrev = -1;
	/**
	 * @uml.property  name="_numFastBytesPrev"
	 */
	int _numFastBytesPrev = -1;

	/**
	 * @uml.property  name="nowPos64"
	 */
	long nowPos64;
	/**
	 * @uml.property  name="_finished"
	 */
	boolean _finished;
	/**
	 * @uml.property  name="_inStream"
	 */
	java.io.InputStream _inStream;

	/**
	 * @uml.property  name="_matchFinderType"
	 */
	int _matchFinderType = EMatchFinderTypeBT4;
	/**
	 * @uml.property  name="_writeEndMark"
	 */
	boolean _writeEndMark = false;

	/**
	 * @uml.property  name="_needReleaseMFStream"
	 */
	...
	/**
	 * @uml.property  name="reps" multiplicity="(0 -1)" dimension="1"
	 */
	int[] reps = new int[Base.kNumRepDistances];
	/**
	 * @uml.property  name="repLens" multiplicity="(0 -1)" dimension="1"
	 */
	int[] repLens = new int[Base.kNumRepDistances];
	/**
	 * @uml.property  name="backRes"
	 */
	int backRes;
	 ...
	 * @uml.property  name="finished" multiplicity="(0 -1)" dimension="1"
	 */
	...
	/**
	 * @uml.property  name="properties" multiplicity="(0 -1)" dimension="1"
	 */
	...
	/**
	 * @uml.property  name="tempPrices" multiplicity="(0 -1)" dimension="1"
	 */
	int[] tempPrices = new int[Base.kNumFullDistances];
	/**
	 * @uml.property  name="_matchPriceCount"
	 */

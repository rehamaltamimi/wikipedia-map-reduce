...
elastic-mapreduce --create --name 'Step4DocSimScorer' \
    ...
    --instance-count 17 --bid-price 1.00  \
    --bootstrap-action s3://elasticmapreduce/bootstrap-actions/configure-hadoop \
    --args "-s,mapred.compress.map.output=false,-s,mapred.map.tasks=500,-s,mapred.reduce.tasks=1500,-s,mapred.tasktracker.reduce.tasks.maximum=16" \
...
#    --args "s3n://macademia/nbrvz/tf-idf-links/step3/,s3n://macademia/nbrvz/tf-idf-links/step4/,2500"
#    --args "-s,mapred.output.compress=true,-s,mapred.output.compression.codec=org.apache.hadoop.io.compress.SnappyCodec,-s,mapred.compress.map.output=false,-s,mapred.map.tasks=500,-s,mapred.reduce.tasks=750,-s,mapred.tasktracker.reduce.tasks.maximum=16" \

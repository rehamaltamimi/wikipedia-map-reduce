...
elastic-mapreduce --create --name 'Step5FinalDocSim' \
    ...
    --args "-s,mapred.map.tasks=1500,-s,mapred.reduce.tasks=1500,-s,mapred.tasktracker.map.tasks.maximum=14,-s,mapred.tasktracker.reduce.tasks.maximum=14,-s,mapred.task.timeout=2000000" \
    --log-uri s3://macademia/nbrvz/logs \
    --enable-debugging \
    --jar s3n://macademia/$jar_dest \
    --main-class wmr.tfidf.Step5FinalDocSim \
    --args "s3n://macademia/nbrvz/tf-idf-words/step4/,s3n://macademia/nbrvz/tf-idf-words/step5/"

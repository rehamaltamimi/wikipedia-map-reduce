 ...
 * 
 */
public class EditorTimes extends Configured implements Tool {

    public static class MyMapper extends Mapper<Long, AllRevisions, Text, Text> {

        /**
         * Outputs contributor name and timestamp for every revision. -Guanyu
         */
        @Override
    ...
    public int run(String args[]) throws Exception {
        ...
        job.setJarByClass(EditorTimes.class);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new EditorTimes(), args);
        System.exit(res);
    }
}
